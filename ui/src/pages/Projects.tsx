...
export function Projects() {
  ...
  const PROJECT_SORT_OPTIONS = useMemo<Array<{ field: ProjectSortField; label: string }>>(
    () => [
      { field: "name", label: t("projects.sortName") },
      { field: "updated", label: t("projects.sortUpdated") },
      { field: "created", label: t("projects.sortCreated") },
      { field: "targetDate", label: t("projects.sortTargetDate") },
    ],
    [t],
  );
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button variant="ghost" size="sm" className="w-fit text-xs" title={t("projects.sort")}>
              ...
              <span>{t("projects.sortBy", { label: sortLabel })}</span>
            </Button>
          </PopoverTrigger>
                ...
                >
                  ...
                  {sortField === option.field ? (
                    <span className="flex items-center gap-1 text-xs text-muted-foreground">
                      ...
                      {sortDir === "asc" ? t("projects.sortAsc") : t("projects.sortDesc")}
                    </span>
                  ) : null}
                </button>
              ))}
