...
export function ApprovalDetail() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      { label: t("approvalDetail.approvals"), href: "/approvals" },
      ...
      ? {
          label:
            (linkedIssues?.length ?? 0) > 1
              ? t("approvalDetail.reviewLinkedTasks")
              : t("approvalDetail.reviewLinkedTask"),
    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="border border-border rounded-lg p-4 space-y-3">
        ...
        {linkedIssues && linkedIssues.length > 0 && (
          <div className="pt-2 border-t border-border/60">
            <p className="text-xs text-muted-foreground mb-1.5">{t("approvalDetail.linkedTasks")}</p>
            ...
            <p className="text-(length:--text-micro) text-muted-foreground mt-2">
              {t("approvalDetail.linkedTasksNote")}
            </p>
          </div>
        )}
        <div className="flex flex-wrap items-center gap-2">
          ...
          {isBudgetApproval && approval.status === "pending" && (
            <p className="text-sm text-muted-foreground">
              {t("approvalDetail.budgetResolveHint", { costsLink: <Link to="/costs" className="underline underline-offset-2">/costs</Link> })}
            </p>
          )}
      ...
      <div className="border border-border rounded-lg p-4 space-y-3">
        ...
        <Textarea
          ...
          placeholder={t("approvalDetail.addCommentPlaceholder")}
          rows={3}
        />
