            ...
            >
                  ...
                  {isEditing ? (
                    ...
                    >
                      ...
                      <Button
                        ...
                        aria-label={t("companies.saveRename")}
                      >
                      ...
                      <Button
                        ...
                        size="icon-xs"
                        onClick={cancelEdit}
                        aria-label={t("companies.cancelRename")}
                      >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        ...
                        aria-label={t("companies.renameAria")}
                      >
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        ...
                        aria-label={t("companies.actionsAria")}
                      >
              ...
              <div className="flex items-center gap-3 sm:gap-5 mt-4 text-sm text-muted-foreground flex-wrap">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    {t("companies.taskCount", { count: issueCount })}
                  </span>
                </div>
                ...
                <div className="flex items-center gap-1.5 ml-auto">
                  ...
                  <span>{t("companies.created", { when: relativeTime(company.createdAt) })}</span>
                </div>
              </div>
